            ...
            <div class="col-lg-6 mx-auto">
                <div class="card shadow">
                    <div class="card-header bg-success text-white text-center py-3">
                        <h4 class="mb-0"><span class="text-success1">DTH</span> <span class="text-info1">Recharge</span></h4>
                    </div>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="modeSelect" name="mode" required>
                                    ...
                                    <option value="AIRTEL DTH" data-id="7">AIRTEL DTH</option>
                                    <option value="DISH TV" data-id="8">DISH TV</option>
                                    <option value="RELIANCE BIGTV" data-id="9">RELIANCE BIGTV</option>
                                    <option value="SUN DIRECT" data-id="10">SUN DIRECT</option>
                                    <option value="TATA SKY" data-id="11">TATA SKY</option>
                                    <option value="VIDEOCON D2H" data-id="12">VIDEOCON D2H</option>
                                </select>
